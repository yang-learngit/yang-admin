<template>
  <div id="drag">
    ...
    <div class="drag_text" onselectstart="return false;" unselectable="on" :class="[isDragOk ? 'whitecolor':'']">
      {{text}}
    </div>
...
<script>
  export default {
    ...
    mounted () {
      ...
      body.addEventListener('mousemove', self.touchmoveFun, false)
      body.addEventListener('mouseup', self.touchendFun, false)

      this.element.addEventListener('touchstart', self.touchstartFun, false)
      body.addEventListener('touchmove', self.touchmoveFun, false)
      body.addEventListener('touchend', self.touchendFun, false)
